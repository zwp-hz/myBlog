    ...
    <div id="lived">
        ...
        <div id="col-md">
            <div class="main container">
                ...
                <!-- <div class="wrap box3" data-0="display: none;" data-2150="top: 403px;opacity: 0;display: block;" data-3000="top: 383px;opacity: 1;">
                    <div class="row">
                        <a class="set" href="javaScript:void(0);">
                            <span class="layer one"><img src="https://placeimg.com/256/256/arch" alt=""></span>
                            <span class="layer two"><img src="https://placeimg.com/256/256/animals" alt=""></span>
